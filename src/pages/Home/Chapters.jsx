                ...
                <div className="grid w-8/10 h-9/12 grid-cols-6 grid-rows-4 gap-5 relative">
                    ...
                    <div className="col-span-2 row-span-3 col-start-4 row-start-2">
                        <div className="grid grid-cols-2 grid-rows-2 gap-5 h-20/21 w-full">
                            <Link to="/levels#hiragana" className="bg-neutral-800 rounded-4xl flex justify-center items-center group hover:bg-neutral-300 transition-colors"><div className="w-6/8 h-6/8 flex flex-col justify-end"><div className=" w-full flex items-center justify-center"><img src="https://res.cloudinary.com/dykzzd9sy/image/upload/v1751840508/torii_sbc71f.webp" className="w-10/16 h-8/9 mr-1" /></div><p className="mt-2 text-2xl font-bold text-shadow-lg group-hover:text-black">CHAPTER: 1</p><p className="mt-1 text-2xl/4 text-shadow-lg group-hover:text-black">HIRAGANA</p></div></Link>
                            <Link to="/levels#katakana" className="bg-neutral-800 rounded-4xl flex justify-center items-center group hover:bg-neutral-300 transition-colors"><div className="w-6/8 h-6/8 flex flex-col justify-end"><div className=" w-full flex items-center justify-center"><img src="https://res.cloudinary.com/dykzzd9sy/image/upload/v1751840508/sushi_ss7txh.webp" className="w-10/16 h-8/9 mr-1" /></div><p className="mt-2 text-2xl font-bold text-shadow-lg group-hover:text-black">CHAPTER: 2</p><p className="mt-1 text-2xl/4 text-shadow-lg group-hover:text-black">KATAKANA</p></div></Link>
                            <Link to="/levels#kanji" className="bg-neutral-800 rounded-4xl flex justify-center items-center group hover:bg-neutral-300 transition-colors"><div className="w-6/8 h-6/8 flex flex-col justify-end"><div className=" w-full flex items-center justify-center"><img src="https://res.cloudinary.com/dykzzd9sy/image/upload/v1751840508/sensu_iusuf7.webp" className="w-10/16 h-8/9 mr-1" /></div><p className="mt-2 text-2xl font-bold text-shadow-lg group-hover:text-black">CHAPTER: 3</p><p className="mt-1 text-2xl/4 text-shadow-lg group-hover:text-black">KANJI</p></div></Link>
                            <Link to="/levels#time" className="bg-neutral-800 rounded-4xl flex justify-center items-center group hover:bg-neutral-300 transition-colors"><div className="w-6/8 h-6/8 flex flex-col justify-end"><div className=" w-full flex items-center justify-center"><img src="https://res.cloudinary.com/dykzzd9sy/image/upload/v1751840508/maneki-neko_cugqw9.webp" className="w-10/16 h-8/9 mr-1" /></div><p className="mt-2 text-2xl font-bold text-shadow-lg group-hover:text-black">CHAPTER: 4</p><p className="mt-1 text-2xl/4 text-shadow-lg group-hover:text-black">TIME</p></div></Link>
                        </div>
                    </div>
                    <div className="row-span-3 col-start-6 row-start-2 relative group hover:text-black hover:cursor-pointer">
                        <img src="https://res.cloudinary.com/dykzzd9sy/image/upload/v1748962013/archiveButton_tjjimm.png" className="w-5/6 h-20/21" />
