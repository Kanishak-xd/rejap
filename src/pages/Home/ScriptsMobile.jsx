    ...
    return (
        <section id="scriptsMobileSection" className="m-4 md:m-8 text-gray-200 min-h-screen flex justify-center items-center pb-0 md:pb-20">
            <div className="mx-auto w-full max-w-[900px] sm:max-w-[900px] md:max-w-[1000px] xl:max-w-[1040px] px-0 sm:px-6 md:px-10 flex flex-col items-center">
                <div className="container mx-auto p-4 my-6 space-y-1 text-center">
                    <p className="font-outfit font-regular text-xl sm:text-3xl md:text-4xl text-amber-50 cursor-default">Japanese language uses</p>
                    <p className="font-outfit font-bold text-3xl sm:text-5xl md:text-6xl text-amber-50 cursor-default">THREE SCRIPTS</p>
                </div>
                <div className="container mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col items-center p-4">
                        <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-amber-50 font-shippori">
                            ひらがな
                        </p>
                        <p className="my-2 text-2xl sm:text-3xl md:text-4xl font-semibold font-outfit">HIRAGANA</p>
                        <div className="space-y-1 leading-tight text-center max-w-xs">
                ...
                <div className="w-full mt-10 md:mt-16 animate-float">
                    <div className="flex flex-col justify-center items-center">
                        <a href="#chaptersSection" className="text-center flex flex-col items-center">
                            <p className="font-semibold text-amber-50 text-base sm:text-lg md:text-2xl mt-2">
                                SCROLL DOWN
                            </p>
